# 🤝 Guide de contribution à Astuces

Merci de votre intérêt pour contribuer à ce dépôt dédié aux astuces, conseils et bonnes pratiques en cybersécurité et IT ! Voici les étapes et bonnes pratiques à suivre :
...
2. **Créez une branche** dédiée à votre contribution :
   ...
   ```
3. **Ajoutez vos modifications** (nouvelle astuce, guide, correction, etc.).
...
Merci pour votre contribution à la communauté Astuces !
